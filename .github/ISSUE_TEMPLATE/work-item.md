...
- 24 saat içinde bağlı Draft PR açılmazsa claim kaldırılır ve Issue tekrar `Available` olur.
- Bir contributor aynı anda yalnızca bir aktif claimed Issue üzerinde çalışabilir.
